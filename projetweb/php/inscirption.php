	...
	<html lang="fr">
        ...
        <nav>
            ...
            <div id="container">
                ...
                <div id="container2">
                 Homme <input type="radio" name="sexe"> Femme <input type ="radio" name ="sexe"> 
                <div class="z-field_spacer"></div>
                   Nom <input type="texte" name="nom"> Prenom <input type ="texte" name ="prenom">
                 <div class="z-field_spacer"></div>    
            <div class="input">    <label>  Nom d'utilisateur </label>  
            <input type="text" name="nom utilisateur" placeholder="ex:Damien" ></div>  
                     <div class="z-field_spacer"></div>
           ...
           <label> Email </label> <input type="text" name="email"  id="email"/>
                    <div class="z-field_spacer"></div>
            <label> Date de naissance </label> <input type="text" name="datenaiss"  id="datenaiss"/>
                    <div class="z-field_spacer"></div>
